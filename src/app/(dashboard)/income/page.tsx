                        ...
                        <table className="w-full table-fixed border-collapse">
                          <thead>
                            <tr className="bg-background-secondary">
                              <th className="text-text-muted w-[22%] px-4 py-3 text-left text-xs font-semibold tracking-wider uppercase sm:px-6 sm:py-4">
                                Month
                              </th>
                              <th className="text-text-muted w-[18%] px-4 py-3 text-left text-xs font-semibold tracking-wider uppercase sm:px-6 sm:py-4">
                                Type
                              </th>
                              <th className="text-text-muted w-[25%] px-4 py-3 text-left text-xs font-semibold tracking-wider uppercase sm:px-6 sm:py-4">
                                Source
                              </th>
                              <th className="text-text-muted w-[23%] px-4 py-3 text-right text-xs font-semibold tracking-wider uppercase sm:px-6 sm:py-4">
                                Amount
                              </th>
                              <th className="text-text-muted w-[12%] px-4 py-3 text-center text-xs font-semibold tracking-wider uppercase sm:px-6 sm:py-4">
                                Actions
                              </th>
                            </tr>
                          </thead>
