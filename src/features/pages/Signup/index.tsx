...
const Signup = () => {
  ...
  const methods = useForm<SignupRequestData>({
    resolver: zodResolver(createSignupSchema(tZod)),
  ...
  return (
    <>
      ...
      <p className="text-text-tertiary mb-5 text-center text-xs sm:mb-6 sm:text-sm">{t('signup.subtitle')}</p>
      ...
      <p className="text-text-muted mt-3 text-center text-xs">
        {t.rich('signup.agreeGoogleNotice', {
          terms: (chunks) => (
