    ...
    >
      ...
      {hasContent && (
        <div
          ...
          aria-live="polite"
          className={twMerge(
            'bg-primary text-primary-foreground pointer-events-none absolute z-50 max-w-[min(20rem,calc(100vw-2rem))] rounded-lg px-3 py-2 text-sm leading-relaxed font-medium break-words whitespace-normal shadow-lg transition-opacity duration-200',
