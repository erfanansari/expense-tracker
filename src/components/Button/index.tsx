...
const baseStyles = 'px-3 sm:px-5 py-2.5 rounded-lg text-sm font-semibold transition-all duration-200 flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed';
...
const variantStyles = {
  ...
  danger: 'bg-white hover:bg-[#fef2f2] border border-[#e5e5e5] hover:border-[#ef4444] text-[#525252] hover:text-[#ef4444]',
};
