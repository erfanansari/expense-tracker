 ...
 * the img carries the brand turquoise plus a light text colour so that a
 * blocked or slow image degrades into a turquoise tile with the brand name —
 * not the grey broken-image glyph.
 */
